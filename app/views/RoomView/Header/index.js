...
class RoomHeaderView extends Component {
	...
	shouldComponentUpdate(nextProps) {
		const {
			type, title, subtitle, status, statusText, connecting, connected, goRoomActionsView, usersTyping, theme, width, height, avatar
		} = this.props;
	...
	render() {
		const {
			title, subtitle: subtitleProp, type, prid, tmid, avatar, widthOffset, status = 'offline', statusText, connecting, connected, usersTyping, goRoomActionsView, roomUserId, theme, width, height, parentTitle
		} = this.props;
