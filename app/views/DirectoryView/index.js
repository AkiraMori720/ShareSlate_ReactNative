...
class DirectoryView extends React.Component {
	...
	constructor(props) {
		...
		this.state = {
			...
			globalUsers: true,
			type: type??props.directoryDefaultView
		};
		this.setHeader();
	}
	...
	setHeader = () => {
		...
		if(isMasterDetail){
			navigation.setOptions({
				title: type==='users'?I18n.t('Create_Direct_Room'):I18n.t('Join_Public_Channel'),
				headerLeft : () => <HeaderButton.CloseModal navigation={navigation} testID='directory-view-close' />
			});
		} else {
			navigation.setOptions({
				title: type==='users'?I18n.t('Create_Direct_Room'):I18n.t('Join_Public_Channel'),
