...
export const USER = createRequestTypes('USER', ['SET', 'SHARE_SET', 'SHARE_ADD_FRIEND']);
export const REQUESTS = createRequestTypes('REQUESTS', ['FETCH', 'SET', 'ADD', 'REMOVE']);
...
export const CONTACTS = createRequestTypes('CONTACTS', ['FETCH', 'FETCH_SUCCESS', 'FETCH_FAILURE', 'SET_REGISTERED', 'SET_CONTACTS'])
