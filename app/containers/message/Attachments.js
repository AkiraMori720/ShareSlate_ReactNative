...
const Attachments = React.memo(({
	attachments, timeFormat, showAttachment, getCustomEmoji, isOwner, theme
}) => {
	...
	return attachments.map((file, index) => {
		...
		return <Reply key={index} index={index} attachment={file} timeFormat={timeFormat} getCustomEmoji={getCustomEmoji} isOwner={isOwner} theme={theme} />;
	});
